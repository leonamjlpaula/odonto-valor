        ...
        <div className="space-y-2">
          ...
          {stats.ociosidadeNaoConfigurada && (
            <div className="rounded-md border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800">
              💡 Sua taxa de <TermTooltip term="ociosidade">ociosidade</TermTooltip> está em 0%. Clínicas típicas ficam com 20% do tempo ocioso —
            ...
            <div className="flex items-center justify-between rounded-lg border border-orange-200 bg-orange-50 px-4 py-3">
              <div>
                ...
                <p className="text-xs text-orange-700 mt-0.5">
                  Itens fixos + <TermTooltip term="depreciacao">depreciação</TermTooltip> + retorno (sem <TermTooltip term="proLabore">pró-labore</TermTooltip>)
                </p>
              </div>
            ...
            <div className="flex items-center justify-between rounded-lg border border-purple-200 bg-purple-50 px-4 py-3">
              <div>
                ...
                <p className="text-xs text-purple-700 mt-0.5">
                  <TermTooltip term="breakEven">Break-even</TermTooltip> mensal (sem pró-labore) ÷ 4 semanas
                </p>
              </div>
